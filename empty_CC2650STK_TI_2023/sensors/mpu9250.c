...
void mpu9250_get_data(I2C_Handle *i2c, float *ax, float *ay, float *az, float *gx, float *gy, float *gz) {
	...
	int16_t nx = ((int16_t)rawData[0]) + (((int16_t)rawData[1]) << 8);
	int16_t ny = ((int16_t)rawData[2]) + (((int16_t)rawData[3]) << 8);
	int16_t nz = ((int16_t)rawData[4]) + (((int16_t)rawData[5]) << 8);
	int16_t mx = ((int16_t)rawData[8]) + (((int16_t)rawData[9]) << 8);
	int16_t my = ((int16_t)rawData[10]) + (((int16_t)rawData[11]) << 8);
	int16_t mz = ((int16_t)rawData[12]) + (((int16_t)rawData[13]) << 8);
